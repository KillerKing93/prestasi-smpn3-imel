            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="/" style="font-size: 17px">Manajemen Prestasi</a>
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ $title == 'Manajemen Siswa' ? 'active' : '' }}">
                            <a href="/petugas/siswa" class='sidebar-link'>
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                          <h6 class="mb-0 text-gray-600">{{ Auth::guard('petugas')->user()->nama }}</h6>
                                          <p class="mb-0 text-sm text-gray-600">{{ Auth::guard('petugas')->user()->level }}</p>
                                        </div>
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                              @if (Auth::guard('petugas')->check() && Auth::guard('petugas')->user()->profil != 0)
                                                <img class="img-profile rounded-circle"
                                                    src="{{ asset(Auth::guard('petugas')->user()->profil) }}"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    style="min-width: 11rem;">
                                      <li>
                                        <a class="dropdown-item" href="/profil_petugas/{{ Auth::guard('petugas')->user()->id_petugas }}">
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2024 &copy; SMPN 03 Kota Bengkulu</p>
                    </div>
                </div>
            </footer> 
        </div>
