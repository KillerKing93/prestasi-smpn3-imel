                    ...
                    <ul class="menu">
                      <li class="sidebar-item {{ $title == 'Dasboard' ? 'active' : '' }} ">
                        ...
                        <li class="sidebar-item {{ $title == 'Manajemen Lomba' ? 'active' : '' }}">
                            <a href="/siswa/lomba" class='sidebar-link'>
                                <i class="bi bi-flag-fill"></i>
                                <span>Manajemen Perlombaan</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ ($title == "Perolehan Prestasi") ? 'active' : '' }}">
                               <a href="/siswa/prestasi" class='sidebar-link'>
            ...
            <nav class="navbar navbar-expand navbar-light navbar-top">
                <div class="container-fluid">
                    ...
                    <div class="user-name text-end me-3">
                        <h6 class="mb-0 text-gray-600">{{ Auth::guard('siswa')->user()->nama }}</h6>
                        <p class="mb-0 text-sm text-gray-600">{{ Auth::guard('siswa')->user()->level }}</p>
                    </div>
                    <div class="user-img d-flex align-items-center">
                        <div class="avatar avatar-md">
                            @if (Auth::guard('siswa')->user()->profil != 0)
                                <img class="img-profile rounded-circle" 
                                    src="{{ asset(Auth::guard('siswa')->user()->profil) }}" 
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                ...
                                <li>
                                    <a class="dropdown-item" href="/siswa/profil/{{ Auth::guard('siswa')->user()->nisn }}">
