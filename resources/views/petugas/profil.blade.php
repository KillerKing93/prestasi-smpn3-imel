            ...
            <div class=" col-xl-8 col-lg-8 col-md-9">
              <div class="card mb-4">
                  ...
                  @endif
                    ...
                    @else
                    <div class="d-flex justify-content-center">
                      <image x="0" y="0" height="100%" preserveAspectRatio="xMidYMid slice" width="100%" src="{{ asset('img/smp.png') }}" style="height: 168px; width: 168px;"></image>
                    </div>
                    @endif
                    
                  <form action="{{ route('petugas_update_profil', ['id_petugas' => $data->id_petugas]) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                        ...
                        <div class="col-md-12 mb-3">
                          <div class="form-group ms-3 me-3">
                            ...
                            <div class="d-flex justify-content-start mb-2">
                              <button type="button" class="btn btn-secondary me-2" onclick="window.location.href='/petugas'">
                                  Kembali
                              </button>
